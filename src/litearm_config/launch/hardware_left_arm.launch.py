...
def generate_launch_description():
    ...
    controllers_file = PathJoinSubstitution([
        litearm_config_path,
        'config',
        'ros2_controllers_hardware_left_arm.yaml'
    ])
    ...
    urdf_file = PathJoinSubstitution([
        litearm_config_path,
        'config',
        'LiteArm_A10_251125_hardware_left_arm.urdf.xacro'
    ])
    ...
    # Left Arm Controller Spawner (delayed start after joint_state_broadcaster)
    ...
    # Left Gripper Controller Spawner (delayed start after left_arm_controller)
    ...
    # Delay left arm controller start until joint_state_broadcaster is loaded
    ...
    # Delay left gripper controller start until left_arm_controller is loaded
    delay_left_gripper_controller_spawner = RegisterEventHandler(
        event_handler=OnProcessExit(
    ...
    return LaunchDescription([
        ...
        delay_left_gripper_controller_spawner,
    ])
