/**
 * @file left_arm_gravity_compensation.cpp
 * @brief 左臂纯重力补偿 - 让手臂在重力作用下自由飘浮
 *
 * 工作原理：
 *   1. 读取当前7个关节角度 q
 ...
 *   或指定配置文件和URDF：
 *   ros2 run litearm_robot left_arm_gravity_compensation <config.yaml> <left_arm.urdf>
 */
...
int main(int argc, char** argv)
{
    try {
        ...
        // 重力补偿力矩增益系数（各关节独立调整）
        std::vector<double> gravity_gain = {0.85, 1, 1.0, 0.8, 1.0, 1.0, 1.0};
